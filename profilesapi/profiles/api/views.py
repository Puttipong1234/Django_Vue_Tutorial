...
class ProfileViewSet(mixins.UpdateModelMixin,
    ...
    queryset = Profile.objects.all()
    serializer_class = ProfileSerializer
    permission_classes = [IsAuthenticated,IsOwnProfileOrReadOnly] ## can be change data only by owner
    
    ## adding search http://127.0.0.1:8000/api/profiles/?search=test
